        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StadiumArea = table.Column<int>(type: "int", nullable: false),
                    NumOfPlayers = table.Column<int>(type: "int", nullable: false),
                    AmPrice = table.Column<float>(type: "real", nullable: false),
                    PmPrice = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlaygroundTimesId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlaygroundId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    PlaygroundId = table.Column<int>(type: "int", nullable: false),
                    PlaygroundTimesId = table.Column<int>(type: "int", nullable: true),
